...
VEC_SIZE = 10*1024
supported_char_list = r"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-,;.!?:'/\|_@#$%^&*~`+-=<>()[]{}\" "
supported_char_map = {}
...
def one_hot_string(string_list, mapping_tuple, string_chunk_length=3):
    ...
    # generate an one-hot-encoded numpy array from the tensor of the chunked string
...
def get_saved_vector_list(read_max='all'):
    ...
    if read_max is not 'all' and isinstance(int, read_max):
